...
output_dir = f'/cs/projects/MWzeronoise/Analysis/4Shivangi/plots/states_lfp/post_exit_10pct/{WIN_TAG}/erp_spectra'
results_dir = '/mnt/cs/projects/MWzeronoise/Analysis/4Shivangi/Results/states_analysis/states_lfp'
results_data_dir = os.path.join(results_dir, "post_exit_10pct", WIN_TAG, "erp_spectra")

pre_exit_output_dir = f'/cs/projects/MWzeronoise/Analysis/4Shivangi/plots/states_lfp/pre_exit_10pct/{WIN_TAG}/erp_spectra'
pre_exit_results_data_dir = os.path.join(results_dir, "pre_exit_10pct", WIN_TAG, "erp_spectra")
