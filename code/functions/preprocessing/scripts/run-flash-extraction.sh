...
#SBATCH --job-name=flash-extraction
#SBATCH --partition=8GBXS
#SBATCH --constraint="cpu_epyc|cpu_xeon"
#SBATCH --mail-user=muad.abd-el-hay@esi-frankfurt.de
#SBATCH --mail-type=END,FAIL
#SBATCH --output=/mnt/hpc_slurm/departmentN5/logs/flash-extraction/%j.out
...
conda activate /mnt/hpc_slurm/departmentN5/conda_envs/oesyncopy_v2

srun python ./preprocessing/align_flashes.py $1
