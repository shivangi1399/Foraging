...
config_path_hands = "/mnt/hpc_slurm/departmentN5/dlc-models/monkey-hand-ZeroNoiseLab-2022-05-10/config.yaml"

as_video_path = str(sys.argv[1])

##check_recalls(os.path.dirname(video_path))
...
deeplabcut.create_labeled_video(
    config=config_path_hands, videos=cs_video_path, destfolder=combinedpath
)
