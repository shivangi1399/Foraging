...
for session in sessions:
    ...
    def reorder_corners(corners_list):
        ...
        if len(corners_list) != 12: # Ensure there are exactly 12 corners
            raise ValueError("There must be exactly 12 corners to reorder (4 per stimulus).")
        
        # Separate the corners for each stimulus
        stimulus1_corners = corners_list[:4]  # First 4 corners
        stimulus2_corners = corners_list[4:8]  # Middle 4 corners
        stimulus3_corners = corners_list[8:12]  # Last 4 corners
        ...
        reordered_stimulus3 = [stimulus3_corners[3], stimulus3_corners[0], stimulus3_corners[1], stimulus3_corners[2]]

        # Combine the reordered corners
        reordered_list = reordered_stimulus1 + reordered_stimulus2 + reordered_stimulus3
    ...
    # dictionaries as time points with time point index as key and the values of the corners as 3D arrays
