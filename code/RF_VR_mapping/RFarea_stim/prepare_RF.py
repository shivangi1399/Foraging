...
os.chdir('/mnt/hpc/projects/MWzeronoise/Analysis/4Shivangi/Results/RF_VR_mapping/RFs/gaussian_fits/20230209')
Fit_az_ele = pd.read_csv("Fit_az_ele.csv", header=None).values
