...
from matplotlib.animation import FuncAnimation, PillowWriter  #use warping env in this
...
for itrl, irec_xy in enumerate(eye_trl): #gives spherical coordinates of the four corners of both the stimuli
    ...
    x, y, z = stim_loc[itrl * n_stimuli + 3].T #was using +3 and +4 before
...
path = '/cs/projects/MWzeronoise/Analysis/4Shivangi/Results/RF_VR_mapping/corners/20230214_try'
