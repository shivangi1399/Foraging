# warping the stimulus abd saving the stimulus outline for each time point in a session
...
def fill_gaps(row):
    ...
    #print(f"Original A: {a_identity_list}, B: {b_identity_list}")
    
    # Rule: Fill B_Identity if A_Identity has a specific value
    ...
    # Rule: Fill A_Identity if B_Identity has a specific value
    ...
    # Debugging information
    #print(f"Filled A: {a_identity_str_filled}, B: {b_identity_str_filled}")
...
output_dir = '/cs/projects/MWzeronoise/Analysis/4Shivangi/Results/RF_VR_mapping/stim_outline/20230214'
